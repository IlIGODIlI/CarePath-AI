  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-8">
      ...
      <div className="flex items-center gap-3">
        <Link 
          to="/dashboard" 
          className="p-2 rounded-lg bg-brand-card border border-brand-slate/10 text-brand-slate hover:text-brand-plum transition-all"
        >
      ...
      <div className="flex flex-col gap-2">
        <h1 className="font-display text-2xl font-bold tracking-tight text-brand-plum">
          Here's what CarePath found
        </h1>
        <p className="text-brand-slate text-sm">
          Clinical routing output generated by the autonomous multi-agent analysis network.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-brand-card border border-brand-slate/10 p-6 rounded-2xl shadow-sm flex flex-col justify-between">
          ...
          <div className="text-xxxxs text-brand-slate/75 leading-relaxed bg-brand-bg p-3.5 rounded-xl border border-brand-slate/10">
            <span className="font-bold text-brand-plum uppercase block mb-1">Healthcare Advisory:</span>
