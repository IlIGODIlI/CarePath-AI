  ...
  return (
    <div className="w-full py-6 md:py-8 px-6 flex flex-col items-center animate-in fade-in duration-500">
      ...
      <div className="max-w-4xl text-center flex flex-col items-center mt-2 md:mt-4 mb-12">
        ...
        <h1 className="font-display font-bold text-5xl md:text-7xl tracking-tight text-brand-plum mb-6 max-w-3xl leading-tight">
          Right Guidance.<br />Right Specialist.<br />
          <span className="text-brand-lavender">Right Time.</span>
        </h1>

        <p className="text-brand-slate text-lg md:text-xl font-light leading-relaxed max-w-2xl mb-10">
      ...
      <div className="max-w-6xl w-full mb-24">
        <div className="text-center mb-16">
          ...
          <p className="text-brand-slate text-md max-w-lg mx-auto">
      ...
      <div className="max-w-3xl w-full bg-brand-card border border-brand-slate/10 p-6 rounded-2xl shadow-sm text-center">
